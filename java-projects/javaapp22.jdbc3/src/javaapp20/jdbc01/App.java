...
public class App {
	...
	public static void main(String[] args) throws SQLException {
		...
		String connectionUrl= "jdbc:postgresql://localhost/mbooks";
		String userName="postgres";
		String password="tr@1n1ng";	//"training";
		
		//step #1 Get Connection
		Connector connector= ()-> DriverManager.getConnection(connectionUrl, userName, password);
		Input input=new Input();
		
		var jdbc=new JdbcManager(connector);
		
		JdbcBookManager manager= new JdbcBookManager(jdbc);
